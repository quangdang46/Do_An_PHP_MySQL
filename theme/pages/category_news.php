          ...
          <ul class="list-item">
            <li class="clearfix">
              ...
              <div class="info fl-right">
                ...
                <p class="desc">Lorem Ipsum chỉ đơn giản là một đoạn văn bản giả, được dùng vào việc trình bày và dàn
                  trang phục vụ cho in ấn. Lorem Ipsum đã được sử dụng như một văn bản chuẩn cho ngành công nghiệp in ấn
                  từ những năm 1500, khi một họa sĩ vô danh ghép nhiều đoạn văn bản với nhau để tạo thành một bản mẫu
                  văn bản.</p>
              </div>
            </li>
            <li class="clearfix">
        ...
        <div class="section-detail">
          <ul class="list-item">
            <li class="clearfix">
              ...
              <div class="info fl-right">
                <a href="?page=detail_product" title="" class="product-name">Bio-Lashes Serum dưỡng dài lông mi và lông
                  mày</a>
                <div class="price-wp">
